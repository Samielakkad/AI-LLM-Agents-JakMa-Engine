...
| 6-dimension verification gating | **partial** | `lib/price-fairness.js` covers 1 dimension. Hard-grounding + ID validation + leak detection + phone-privacy gate cover ~4 more. Framing: **"4-dim verification, extensible to 6"** |
